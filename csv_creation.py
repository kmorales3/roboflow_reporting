...
def compare_job_dfs():
    ...
    if not new_data_df.empty:
        ...
        combined_job_diff_df['sum'] = combined_job_diff_df['annotated'] + combined_job_diff_df['unannotated']
        combined_job_diff_df = combined_job_diff_df[combined_job_diff_df['sum'] != 0]
